...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HAMIDA RASHID\\Desktop\\New folder\\Lab in Psychology\\Psychopy_exp\\visual search task\\visual search task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        if random() > 0.5:  # Use random.random() to get a float between 0 and 1
            num_distr = 5
        ...
        for i in range(num_distr):
            distr = visual.TextStim(win=win, name='distr',
                text='L',
                font='Arial',
                pos=(random() - 0.5, random() - 0.5),  # Add comma between x and y
                height=0.05, wrapWidth=None, ori=randint(1,360),  # Use random() for orientation
                color='white', colorSpace='rgb', opacity=None, 
                languageStyle='LTR',
                depth=-2.0)
        ...
        for distr in distractors:
            distr.setAutoDraw(False)  # Added missing colon
