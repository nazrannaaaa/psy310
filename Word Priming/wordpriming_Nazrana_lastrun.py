...
expName = 'WORD_PRIMING_DISHA'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\HAMIDA RASHID\\Desktop\\New folder\\Lab in Psychology\\Psychopy_exp\\data\\wordpriming_Nazrana\\wordpriming_Nazrana_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('Downloads/Study_Word.xlsx'),
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Desktop/New folder/Lab in Psychology/word priming .csv'),
